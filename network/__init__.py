...
GAME_CONFIGS = {
    ...
    "santorini": {
        ...
        "default_iterations": 32, "default_games": 64, "default_simulations": 256,
        "selects_per_round": 8, "vl_value": 3.0,
        "value_loss_weight": 5.0,
        "temp_threshold": 20, "c_puct": 1.5,
    },
}
